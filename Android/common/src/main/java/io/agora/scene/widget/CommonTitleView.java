...
import io.agora.scene.base.databinding.ViewCommonTitleBinding;
...
public final class CommonTitleView extends ConstraintLayout {
     ...
     */
    public void setLeftClick(@Nullable OnClickListener onClickListener) {
    ...
    /**
     * Sets right icon click.
     *
     * @param onClickListener the on click listener
     */
    public void setRightIconClick(@Nullable OnClickListener onClickListener) {
        if (onClickListener != null) {
    ...
    /**
     * Instantiates a new Common title view.
     *
