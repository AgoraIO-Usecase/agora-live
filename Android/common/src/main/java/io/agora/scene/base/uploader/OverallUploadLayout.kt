    ...
    fun uploadStatus(uploadStatus: UploadStatus, uuid: String) {
        ...
        when (uploadStatus) {
            UploadStatus.Upload_loading -> {
                binding.ivUploading.setImageResource(R.mipmap.icon_upload_loading)
            ...
            UploadStatus.Upload_Complete -> {
                binding.ivUploading.setImageResource(R.mipmap.icon_upload_success)
            ...
            UploadStatus.Upload_Failed -> {
                binding.ivUploading.setImageResource(R.mipmap.icon_upload_error)
