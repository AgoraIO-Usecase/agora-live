...
object ApiCostEvent {
    ...
    const val FIRST_FRAME_ACTUAL = "firstFrameActual"        // Actual Time to First Frame.
    const val FIRST_FRAME_PERCEIVED = "firstFramePerceived"  // Time to First Frame Perception.
}
