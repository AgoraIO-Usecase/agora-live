...
public class MyScoringView extends ScoringView {
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        if (changed) {
            int colorWhite35 = getResources().getColor(io.agora.scene.base.R.color.white_35_percent);
            int colorWhite = getResources().getColor(io.agora.scene.base.R.color.white);
