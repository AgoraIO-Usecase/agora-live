...
class MusicSettingDialog constructor(
    ...
    private var currentSong: ChosenSongInfo?,
) :
    ...
    private fun setupVoiceEffectAdapter() {
        ...
        for (i in stringArray.indices) {
            val drawable: Int = if (i % 4 == 0) {
                io.agora.scene.base.R.mipmap.bg_sound_mode_4
            } else if (i % 3 == 0) {
                io.agora.scene.base.R.mipmap.bg_sound_mode_3
            } else if (i % 2 == 0) {
                io.agora.scene.base.R.mipmap.bg_sound_mode_2
            } else {
                io.agora.scene.base.R.mipmap.bg_sound_mode_1
            }
