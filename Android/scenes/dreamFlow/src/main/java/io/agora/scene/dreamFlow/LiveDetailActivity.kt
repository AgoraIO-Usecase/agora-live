...
import io.agora.scene.dreamFlow.databinding.DreamFlowLiveDetailActivityBinding
import io.agora.scene.dreamFlow.service.RoomDetailModel
import io.agora.scene.dreamFlow.service.ShowServiceProtocol
import io.agora.scene.dreamFlow.utils.RunnableWithDenied
import io.agora.scene.dreamFlow.videoLoaderAPI.AGSlicingType
 ...
 */
class LiveDetailActivity : BaseViewBindingActivity<DreamFlowLiveDetailActivityBinding>() {
    /**
     * Tag
     */
     ...
     * @return
     */
    override fun getViewBinding(inflater: LayoutInflater): DreamFlowLiveDetailActivityBinding {
        return DreamFlowLiveDetailActivityBinding.inflate(inflater)
    }
