...
object VideoSetting {
    ...
    fun updateBroadcastSetting(
        ...
        DreamFlowLogger.d("VideoSettings", "updateBroadcastSetting, deviceLevel:$deviceLevel networkLevel:$networkLevel broadcastStrategy:$broadcastStrategy")
    ...
    fun getRecommendBroadcastSetting(): BroadcastSetting {
        return when (currAudienceDeviceLevel) {
            DeviceLevel.Low -> RecommendBroadcastSetting.LowDevice1v1
            DeviceLevel.Medium -> RecommendBroadcastSetting.MediumDevice1v1
...
//            )
    ...
    private fun updateRTCBroadcastSetting(
        ...
        DreamFlowLogger.d("VideoSettings", "updateRTCBroadcastSetting, frameRate:$frameRate")
        val rtcEngine = RtcEngineInstance.rtcEngine
