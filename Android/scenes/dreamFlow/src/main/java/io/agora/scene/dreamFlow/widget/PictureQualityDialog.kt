...
import io.agora.scene.dreamFlow.databinding.DreamFlowWidgetPictureQualityDialogBinding
import io.agora.scene.dreamFlow.databinding.DreamFlowWidgetPictureQualityDialogItemBinding
...
class PictureQualityDialog(context: Context) : BottomDarkDialog(context) {
    ...
    companion object {
        ...
        private val QualityItemList = arrayListOf(
            QualityItem(QUALITY_INDEX_1080P, R.string.dream_flow_picture_quality_1080p, Size(1080, 1920)),
            QualityItem(QUALITY_INDEX_720P, R.string.dream_flow_picture_quality_720p, Size(720, 1280)),
            QualityItem(QUALITY_INDEX_540P, R.string.dream_flow_picture_quality_540p, Size(540, 960)),
            QualityItem(QUALITY_INDEX_360P, R.string.dream_flow_picture_quality_360p, Size(360, 640)),
            QualityItem(QUALITY_INDEX_270P, R.string.dream_flow_picture_quality_270p, Size(270, 480)),
            QualityItem(QUALITY_INDEX_180P, R.string.dream_flow_picture_quality_180p, Size(180, 320)),
        )
    ...
    private val mBinding by lazy {
        DreamFlowWidgetPictureQualityDialogBinding.inflate(
            LayoutInflater.from(
                context
            )
        )
    ...
    private val mAdapter by lazy {
        object : BindingSingleAdapter<QualityItem, DreamFlowWidgetPictureQualityDialogItemBinding>() {
            override fun onBindViewHolder(
                holder: BindingViewHolder<DreamFlowWidgetPictureQualityDialogItemBinding>,
                position: Int
            ) {
