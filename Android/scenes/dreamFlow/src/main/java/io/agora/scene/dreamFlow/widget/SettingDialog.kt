...
import io.agora.scene.dreamFlow.databinding.DreamFlowWidgetSettingDialogBinding
import io.agora.scene.dreamFlow.databinding.DreamFlowWidgetSettingDialogItemBinding
...
class SettingDialog(context: Context) : BottomDarkDialog(context) {
    ...
    private val mAudienceItemList = listOf(
        SettingItem(
            ...
            R.drawable.commerce_setting_ic_statistic,
            R.string.dream_flow_setting_statistic,
            R.string.dream_flow_setting_statistic
        ),
        SettingItem(
            ITEM_ID_SETTING,
            ...
            R.drawable.commerce_setting_ic_setting,
            R.string.dream_flow_setting_advance_setting,
            R.string.dream_flow_setting_advance_setting
        )
    )
    ...
    private val mHostItemList = listOf(
        SettingItem(
            ...
            R.drawable.commerce_setting_ic_camera,
            R.string.dream_flow_setting_switch_camera,
            R.string.dream_flow_setting_switch_camera
        ),
        SettingItem(
            ITEM_ID_VIDEO,
            ...
            R.string.dream_flow_setting_video_off,
            R.string.dream_flow_setting_video_on,
            isVideoActivated
        ),
        SettingItem(
            ITEM_ID_MIC,
            ...
            R.string.dream_flow_setting_mic_off,
            R.string.dream_flow_setting_mic_on,
            isVoiceActivated
        ),
        SettingItem(
            ITEM_ID_STATISTIC,
...
//            R.drawable.commerce_setting_ic_quality,
//            R.string.dream_flow_setting_quality,
//            R.string.dream_flow_setting_quality
//        ),
        SettingItem(
            ITEM_ID_SETTING,
    ...
    private val mBinding by lazy {
        DreamFlowWidgetSettingDialogBinding.inflate(
            LayoutInflater.from(
                context
            )
        )
    ...
    private val mAdapter by lazy {
        object : BindingSingleAdapter<SettingItem, DreamFlowWidgetSettingDialogItemBinding>() {
            override fun onBindViewHolder(
                holder: BindingViewHolder<DreamFlowWidgetSettingDialogItemBinding>,
                position: Int
            ) {
