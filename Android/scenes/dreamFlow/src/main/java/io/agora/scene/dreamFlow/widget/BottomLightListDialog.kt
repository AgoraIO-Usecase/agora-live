...
import io.agora.scene.dreamFlow.databinding.DreamFlowWidgetBottomLightListDialogBinding
import io.agora.scene.dreamFlow.databinding.DreamFlowWidgetBottomLightListItemBinding
...
open class BottomLightListDialog(context: Context) : BottomLightDialog(context) {
    ...
    private val mBinding by lazy {
        DreamFlowWidgetBottomLightListDialogBinding.inflate(
            LayoutInflater.from(
                context
            )
        )
    ...
    private val mAdapter by lazy {
        object : BindingSingleAdapter<String, DreamFlowWidgetBottomLightListItemBinding>(){
            override fun onBindViewHolder(
                holder: BindingViewHolder<DreamFlowWidgetBottomLightListItemBinding>,
                position: Int
            ) {
