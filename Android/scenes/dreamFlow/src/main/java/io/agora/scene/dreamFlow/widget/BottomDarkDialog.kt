...
import io.agora.scene.dreamFlow.databinding.DreamFlowWidgetBottomDarkDialogBinding
...
open class BottomDarkDialog : BottomSheetDialog {
     ...
     * M binding
     */
    private val mBinding by lazy { DreamFlowWidgetBottomDarkDialogBinding.inflate(LayoutInflater.from(context)) }
