...
class AdvanceSettingAudienceDialog constructor(context: Context) : BottomFullDialog(context) {
    ...
    private val mBinding by lazy {
        DreamFlowSettingAdvanceDialogAudienceBinding.inflate(
            LayoutInflater.from(
                context
            )
        )
    ...
    init {
        ...
        setupSwitchItem(ITEM_ID_SWITCH_QUALITY_ENHANCE, mBinding.qualityEnhance, R.string.dream_flow_setting_advance_quality_enhance, View.NO_ID)
    }
