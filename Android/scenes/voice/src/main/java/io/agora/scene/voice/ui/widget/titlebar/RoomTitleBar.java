package io.agora.scene.voice.ui.widget.titlebar;
...
public class RoomTitleBar extends RelativeLayout implements View.OnClickListener {
    ...
    public RoomTitleBar(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public RoomTitleBar(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void init(Context context, AttributeSet attrs) {
        LayoutInflater.from(context).inflate(R.layout.voice_widget_title_bar_layout, this);
        ...
        if (attrs != null) {
            ...
            if (titleTextColor != -1) {
                ...
                mTitleTextColor = ta.getColor(R.styleable.voice_RoomTitleBar_voice_titleBarTitleTextColor,
                        ContextCompat.getColor(getContext(), io.agora.scene.base.R.color.black));
            }
    ...
    public void setToolbarCustomColorDefault(@ColorInt int colorId) {
        Drawable leftArrow = ContextCompat.getDrawable(getContext(), R.drawable.voice_icon_tab_back_empty);
        if (leftArrow != null) {
