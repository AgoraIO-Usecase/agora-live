 ...
 */
package io.agora.scene.voice.ui.widget.like;
...
public class LikeLayout extends RelativeLayout implements View.OnClickListener {
    ...
    private void findViewById(Context context) {
        View view = LayoutInflater.from(context).inflate(R.layout.voice_widget_gift_periscope, this);
        imageView = view.findViewById(R.id.img);
        imageView.setOnClickListener(this);
        bitmap = BitmapFactory.decodeResource(getResources(), R.drawable.voice_icon_like);
    ...
    private static int[] drawableIds = new int[]{R.drawable.voice_icon_like_1, R.drawable.voice_icon_like_2, R.drawable.voice_icon_like_3, R.drawable.voice_icon_like_4, R.drawable.voice_icon_like_5, R.drawable.voice_icon_like_6};
