...
import io.agora.scene.eCommerce.databinding.CommerceWidgetBottomLightDialogBinding
...
open class BottomLightDialog : BottomSheetDialog {
     ...
     * M binding
     */
    private val mBinding by lazy { CommerceWidgetBottomLightDialogBinding.inflate(LayoutInflater.from(context)) }
