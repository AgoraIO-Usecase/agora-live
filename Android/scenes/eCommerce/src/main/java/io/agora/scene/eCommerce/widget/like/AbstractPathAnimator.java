 ...
 */
package io.agora.scene.eCommerce.widget.like;
...
public abstract class AbstractPathAnimator {
    ...
    public static class Config {
        ...
        static public Config fromTypeArray(TypedArray typedArray, float x, float y, int pointx, int heartWidth, int heartHeight) {
            ...
            config.initX = (int) typedArray.getDimension(R.styleable.commerce_LikeLayout_commerce_initX, x);
            config.initY = (int) typedArray.getDimension(R.styleable.commerce_LikeLayout_commerce_initY, y);
            config.xRand = (int) typedArray.getDimension(R.styleable.commerce_LikeLayout_commerce_xRand, res.getDimensionPixelOffset(R.dimen.commerce_like_anim_bezier_x_rand));
            config.animLength = (int) typedArray.getDimension(R.styleable.commerce_LikeLayout_commerce_animLength, res.getDimensionPixelOffset(R.dimen.commerce_like_anim_length));
            config.animLengthRand = (int) typedArray.getDimension(R.styleable.commerce_LikeLayout_commerce_animLengthRand, res.getDimensionPixelOffset(R.dimen.commerce_like_anim_length_rand));
            config.bezierFactor = typedArray.getInteger(R.styleable.commerce_LikeLayout_commerce_bezierFactor, 6);
