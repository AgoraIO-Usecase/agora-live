...
import io.agora.scene.eCommerce.databinding.CommerceWidgetToastLayoutBinding
...
class ToastDialog : Dialog {
    ...
    private val mBinding by lazy {
        CommerceWidgetToastLayoutBinding.inflate(LayoutInflater.from(context))
    }
    ...
    constructor(context: Context) : this(context, R.style.commerce_toast_dialog)
