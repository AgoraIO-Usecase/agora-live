...
import io.agora.scene.eCommerce.databinding.CommerceWidgetBottomLightListDialogBinding
...
open class BottomLightListDialog(context: Context) : BottomLightDialog(context) {
    ...
    private val mBinding by lazy {
        CommerceWidgetBottomLightListDialogBinding.inflate(
            LayoutInflater.from(
                context
            )
        )
    ...
    private val mAdapter by lazy {
        object : BindingSingleAdapter<String, CommerceWidgetBottomLightListItemBinding>(){
            override fun onBindViewHolder(
                holder: BindingViewHolder<CommerceWidgetBottomLightListItemBinding>,
                position: Int
            ) {
