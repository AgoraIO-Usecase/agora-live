...
public class LikeLayout extends RelativeLayout implements View.OnClickListener {
    ...
    private void findViewById(Context context) {
        View view = LayoutInflater.from(context).inflate(R.layout.commerce_widget_gift_periscope, this);
    ...
    private void init(AttributeSet attrs, int defStyleAttr) {
        final TypedArray a = getContext().obtainStyledAttributes(
                attrs, R.styleable.commerce_LikeLayout, defStyleAttr, 0);
    ...
    private static int[] drawableIds = new int[]{R.drawable.commerce_icon_like_1, R.drawable.commerce_icon_like_2, R.drawable.commerce_icon_like_3, R.drawable.commerce_icon_like_4, R.drawable.commerce_icon_like_5, R.drawable.commerce_icon_like_6};
