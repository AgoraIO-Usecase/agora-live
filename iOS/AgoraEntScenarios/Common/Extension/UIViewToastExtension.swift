...
public extension UIView {
    private enum ToastKeys {
        static var timer = "com.voice-room.timer"
        static var duration = "com.voice-room.duration"
        static var point = "com.voice-room.point"
        static var completion = "com.voice-room.completion"
        static var activeToasts = "com.voice-room.activeToasts"
        static var activityView = "com.voice-room.activityView"
        static var queue = "com.voice-room.queue"
    }
    ...
    func toastViewForMessage(_ message: String?, title: String?, image: UIImage?, style: ToastStyle) throws -> UIView {
        ...
        let wrapperView = UIToolbar()
        wrapperView.barStyle = .black
        wrapperView.isTranslucent = true
...
public enum ToastPosition {
    ...
    fileprivate func centerPoint(forToast toast: UIView, inSuperview superview: UIView) -> CGPoint {
        ...
        case .bottom:
            return CGPoint(x: superview.bounds.size.width / 2.0, y: superview.bounds.size.height - toast.frame.size.height - bottomPadding)
        }
    }
}
