...
TODO: Add long description of the pod here.
  ...
  s.source_files = ['Context/*.swift',
                    ...
                    'Common/Manager/VLDefine/*',
                    'Common/Manager/Authorized/*',
                    'Common/Manager/StateManager/*',
                    'Common/Extension/*',
                    'Common/UI/Base/ViewController/*',
                    'Common/UI/Base/View/*',
                    'Common/UI/Toast/*',
                    'Common/UI/VLNetwork/Request/*',
                    'Common/UI/VLNetwork/Model/*',
                    'Common/UI/VLNetwork/Configure/*',
                    'Common/UI/VLFont/*',
                    'Common/UI/VLEmptyView/*',
                    'Common/UI/VLHotSpotBtn/*',
                    'Common/UI/WebView/*',
                    'Common/UI/ToastView/*',
                    'Common/Category/NSString/*',
                    'Common/Category/NSObject/*',
                    'Common/Category/UIView/*',
                    'Common/Category/UIGestureRecognizer/*',
                    'Common/Utils/*',
                    'Common/ThirdParty/QMUI/*',
