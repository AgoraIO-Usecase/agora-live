...
class KTVCreateRoomPresentView: UIView, UIGestureRecognizerDelegate {
    ...
    fileprivate var frames: [CGRect] = [] //Save all frames to ensure that each height you come back is set by you before.
    fileprivate var maxHeights: [CGFloat] = [] //Save the maximum height of each view
    fileprivate var minHeights: [CGFloat] = [] //Save the minimum height of each view
