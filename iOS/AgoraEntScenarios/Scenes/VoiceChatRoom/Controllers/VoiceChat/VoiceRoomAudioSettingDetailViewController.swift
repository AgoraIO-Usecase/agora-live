...
class VoiceRoomAudioSettingDetailViewController: UIViewController {
    ...
    var soundEffect: Int = 1 {
        didSet {
            ...
            let socialH: CGFloat = textHeight(text: "voice_chatroom_social_chat_introduce".voice_localized, fontSize: 13, width: self.view.bounds.size.width - 80)
    ...
    var settingType: AUDIO_SETTING_TYPE = .Spatial {
        didSet {
            ...
            VoiceChatLog.info("\(titleLabel.text!)  \(backBtn.accessibilityIdentifier!)")
...
//                 backBlock();
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        if settingType == .effect {
            ...
            VoiceChatLog.info("other settingType")
        }
    }
