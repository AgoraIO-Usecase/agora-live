//
//  VRCreateRoomPresentView.swift
//  VRCreateRoomPresentView
//
...
class VRCreateRoomPresentView: UIView, UIGestureRecognizerDelegate {
    
    fileprivate let screenSize: CGSize = UIScreen.main.bounds.size
    
    @objc static var shared: VRCreateRoomPresentView = VRCreateRoomPresentView()
