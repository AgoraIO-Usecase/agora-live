...
class VoiceCreateRoomView: UIView {
    ...
    func setupView() {
        ...
        randomBtn.setImage(UIImage.sceneImage(name: "online_create_randomIcon"), for: .normal)
        ...
        secretLabel.text = "voice_room_access".voice_localized
        ...
        self.setLabel.text = "voice_enter_4_digit_password".voice_localized
    ...
    func createRandomNumber() {
        let namePrefix = "voice_chat_room".voice_localized
        let date = Date()
