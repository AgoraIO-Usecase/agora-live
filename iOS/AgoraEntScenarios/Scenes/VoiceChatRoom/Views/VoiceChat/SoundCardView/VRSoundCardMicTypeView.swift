...
class VRSoundCardMicTypeView: UIView {
    ...
    private func layoutUI() {
        ...
        headTitleLabel.text = "voice_microphone_type".voice_localized
        ...
        tableView.registerCell(VRSoundCardMicTypeCell.self, forCellReuseIdentifier: "cell")
        ...
        cancleView.setTitle("voice_cancel".voice_localized, for: .normal)
...
extension VRSoundCardMicTypeView: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.titleLabel.text = "voice_microphone_type".voice_localized+"\(text)"
