...
//  VoiceRoomBaseUIKit
//
//Created by Zhu Jichao on September 2, 2022
//
...
public class VoiceRoomAlertContainer: UIView {
    lazy var indicator: UIImageView = .init(frame: CGRect(x: ScreenWidth / 2.0 - 19, y: 6, width: 38, height: 3)).image(UIImage.sceneImage(name: "pop_indicator", bundleName: "VoiceChatRoomResource")!)
