...
class VMEQSettingView: UIView, UITextViewDelegate {
    ...
    var soundEffect: Int = 1 {
        didSet {
            ...
            let socialH: CGFloat = textHeight(text: "voice_chatroom_social_chat_introduce".voice_localized, fontSize: 13, width: bounds.size.width - 80)
            let ktvH: CGFloat = textHeight(text: "voice_chatroom_karaoke_introduce".voice_localized, fontSize: 13, width: bounds.size.width - 80)
            let gameH: CGFloat = textHeight(text: "voice_chatroom_gaming_buddy_introduce".voice_localized, fontSize: 13, width: bounds.size.width - 80)
            let anchorH: CGFloat = textHeight(text: "voice_chatroom_professional_broadcaster_introduce".voice_localized, fontSize: 13, width: bounds.size.width - 80)
            print("\(soundEffect)-----")
            switch soundEffect {
            case 1:
