...
class VMManagerView: UIView {
    ...
    public var micInfo: VRRoomMic? {
        didSet {
            ...
            if m_type == -1 {
                ...
                lockBtn.setTitle("voice_unblock".voice_localized, for: .normal)
    ...
    private func layoutUI() {
        ...
        roleBtn.setTitle("voice_host".voice_localized, for: .normal)
        ...
        inviteBtn.setTitle("voice_invite".voice_localized, for: .normal)
        ...
        lockBtn.setTitle("voice_block".voice_localized, for: .normal)
