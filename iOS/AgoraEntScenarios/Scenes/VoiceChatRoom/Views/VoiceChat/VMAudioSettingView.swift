...
class VMAudioSettingView: UIView {
    ...
    private var settingName: [String] = ["voice_AINS".voice_localized,
                                         "voice_AIAEC".voice_localized,
                                         "voice_AGC".voice_localized,
                                         "voice_SoundCard".voice_localized,
                                         "voice_agora_blue_and_red_bot".voice_localized,
                                         "voice_robot_volume".voice_localized,
                                         "voice_best_agora_sound".voice_localized,
                                         "voice_spatial_audio".voice_localized]
