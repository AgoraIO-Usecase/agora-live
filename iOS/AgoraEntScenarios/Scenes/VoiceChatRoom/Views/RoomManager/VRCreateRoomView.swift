...
public class VRCreateRoomView: UIView, HorizontalCardsDelegate, HorizontalCardsDataSource {
    private let datas = [["title": "voice_chat_room".voice_localized, "detail": "voice_multi_audio_chat_scenario_where_anyone_can_unmute_their_mic_and_speak".voice_localized + "\n" + "voice_co_Watch_team_chat_gaming_buddy_chat".voice_localized, "image": "chat_room"]]
...
//        }
    ...
    private func addWarningView() {
        let text = "voice_create_tips".voice_localized
...
public extension VRCreateRoomView {
    ...
    @objc private func randomRoomName() {
        var namePrefix = "voice_chat_room".voice_localized
        if idx == 1 {
            namePrefix = "voice_spatial_audio_mode_room".voice_localized
        }
