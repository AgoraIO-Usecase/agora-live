...
protocol CommerceSettingSliderCellDelegate: NSObjectProtocol {
        
    func onCellSliderValueChanged(value: Float, at index: IndexPath)
}

class CommerceSettingSliderCell: CommerceSettingBaseCell {
    
    weak var delegate: CommerceSettingSliderCellDelegate?
...
private extension CommerceSettingSliderCell {
