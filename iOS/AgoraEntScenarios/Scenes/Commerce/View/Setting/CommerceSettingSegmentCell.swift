...
fileprivate class CommerceSettingSegmentView: UIView {
    ...
    var titles: [String]?{
        didSet {
            ...
            for i in 0 ..< titles.count {
                ...
                button.titleLabel?.font = .commerce_R_11
                button.setTitle(titles[i], for: .normal)
                button.setTitleColor(.commerce_segment_title_nor, for: .normal)
                button.setTitleColor(.commerce_zi03, for: .selected)
                button.setImage(UIImage(color: .commerce_segment_bg), for: .normal)
                button.setImage(UIImage(color: .commerce_main_text), for: .selected)
                button.layer.borderWidth = 1
                button.layer.cornerRadius = 4
                button.layer.borderColor = UIColor.commerce_segment_border.cgColor
    ...
    @objc private func didClickButton(_ button: UIButton) {
        for btn in buttonArray {
            ...
            btn.layer.borderColor = btn.isSelected ? UIColor.commerce_zi03.cgColor : UIColor.commerce_segment_border.cgColor
        }
...
class CommerceSettingSegmentCell: CommerceSettingBaseCell {

    private let segmentView: CommerceSettingSegmentView = CommerceSettingSegmentView()
