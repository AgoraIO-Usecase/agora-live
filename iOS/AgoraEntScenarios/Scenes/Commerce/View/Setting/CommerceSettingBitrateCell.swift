...
protocol CommerceSettingBitrateCellDelegate: NSObjectProtocol {
...
class CommerceSettingBitrateCell: CommerceSettingBaseCell {
    
    weak var delegate: CommerceSettingBitrateCellDelegate?
...
private extension CommerceSettingBitrateCell {
    
    func createViews() {
        detailButton.isHidden = false
        
        valueLabel.textColor = .commerce_Ellipse5
        valueLabel.font = .commerce_R_14
        ...
        slider.maximumTrackTintColor = .commerce_Ellipse2
