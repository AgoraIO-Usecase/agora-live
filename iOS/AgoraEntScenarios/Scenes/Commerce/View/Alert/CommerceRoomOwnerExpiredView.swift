//
//  CommerceRoomOwnerExpiredView.swift
//  AgoraEntScenarios
//
...
class CommerceRoomOwnerExpiredView: UIView {
...
extension CommerceRoomOwnerExpiredView {
    @objc private func didClickBackButton() {
        self.clickBackButtonAction?()
    }
}

class CommerceGradientButton: UIButton {
