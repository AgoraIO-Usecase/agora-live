...
class CommerceRoomListCell: UICollectionViewCell {
    ...
    private lazy var liveStatusLabel: UILabel = {
       let label = UILabel()
        label.text = "show_living".commerce_localized
    ...
    func setBgImge(_ img: String, name: String?, id: String?, count: Int) {
        ...
        if #available(iOS 13.0, *) {
            ...
            attachment.image = UIImage.commerce_sceneImage(name: "show_room_person")
        }
    ...
    private func createSubviews(){
        ...
        indicatorImgView.image = UIImage.commerce_sceneImage(name: "show_live_indictor")
        ...
        coverImgView.image = UIImage.commerce_sceneImage(name: "show_list_cover")
        ...
        nameLabel = UILabel()
        nameLabel.font = .commerce_M_12
        nameLabel.textColor = .commerce_main_text
        ...
        // id
        idLablel = UILabel()
        idLablel.font = .commerce_R_10
        idLablel.textColor = .commerce_main_text
        ...
        numberLabel = UILabel()
        numberLabel.font = .commerce_R_10
        numberLabel.textColor = .commerce_main_text
