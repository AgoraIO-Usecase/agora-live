...
class CommerceBeautyFaceVC: UIViewController {
    ...
    private lazy var collectionView: UICollectionView = {
        ...
        collectionView.register(CommerceBeautyFaceCell.self, forCellWithReuseIdentifier: NSStringFromClass(CommerceBeautyFaceCell.self))
...
//        case .filter: return ShowBeautyFaceVC.filterData
    ...
    private var type: CommerceBeautyFaceVCType = .beauty
    
    init(type: CommerceBeautyFaceVCType) {
...
//                                                     value: model.value)
        ...
        case .background:
            if model.path == nil {
                CommerceAgoraKitManager.isOpenGreen = false
                CommerceAgoraKitManager.isBlur = false
                CommerceAgoraKitManager.shared.enableVirtualBackground(isOn: false)
                CommerceAgoraKitManager.shared.seVirtualtBackgoundImage(imagePath: nil,
                                                                        isOn: false)
            } else if model.path == "xuhua" {
                CommerceAgoraKitManager.isBlur = true
                CommerceAgoraKitManager.shared.enableVirtualBackground(isOn: true,
                                                                       greenCapacity: Float(value))
                
            } else {
                CommerceAgoraKitManager.isBlur = false
                CommerceAgoraKitManager.shared.seVirtualtBackgoundImage(imagePath: model.key,
                                                                        isOn: true,
                                                                        greenCapacity: Float(value))
            }
        }
...
extension CommerceBeautyFaceVC: UICollectionViewDelegateFlowLayout, UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell: CommerceBeautyFaceCell = collectionView.dequeueReusableCell(withReuseIdentifier: NSStringFromClass(CommerceBeautyFaceCell.self),
                                                                              for: indexPath) as! CommerceBeautyFaceCell
...
extension CommerceBeautyFaceVC : JXCategoryListContentViewDelegate {
