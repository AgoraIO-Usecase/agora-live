...
class CommercePresentAnimator: NSObject , UIViewControllerAnimatedTransitioning {
...
class CommerceDismissAnimator: NSObject , UIViewControllerAnimatedTransitioning {
...
class CommercePresentTransitioningDelegate: NSObject, UIViewControllerTransitioningDelegate {
    
    func animationController(forDismissed dismissed: UIViewController) -> UIViewControllerAnimatedTransitioning? {
        return CommerceDismissAnimator()
    }
    
    func animationController(forPresented presented: UIViewController, presenting: UIViewController, source: UIViewController) -> UIViewControllerAnimatedTransitioning? {
        return CommercePresentAnimator()
    }
}
