...
#import "CommerceAEACategoryView.h"
#import "CommerceAEACategoryTitleCell.h"


static NSString * const kTitleCellID = @"AEACategoryTitleCell";

@implementation CommerceAEACategoryItem

+ (instancetype)itemWithNormalImage:(UIImage *)normalImage selectedImage:(UIImage *)selectedImage {
    CommerceAEACategoryItem *item = [CommerceAEACategoryItem new];
...
@implementation CommerceAEACategoryViewLayout

+ (instancetype)defaultLayout {
    CommerceAEACategoryViewLayout *layout = [CommerceAEACategoryViewLayout new];
...
@interface CommerceAEACategoryView ()<UICollectionViewDataSource, UICollectionViewDelegateFlowLayout>
{
...
@property (nonatomic, strong) CommerceAEACategoryViewLayout *categoryLayout;

@end

@implementation CommerceAEACategoryView

+ (instancetype)defaultCategoryView {
    return [self categoryViewWithLayout:[CommerceAEACategoryViewLayout defaultLayout]];
}

+ (instancetype)categoryViewWithLayout:(CommerceAEACategoryViewLayout *)layout {
    CommerceAEACategoryView *view = [CommerceAEACategoryView new];
...
- (void)createSubviewsWithLayout:(CommerceAEACategoryViewLayout *)categoryLayout {
    ...
    [_collectionView registerClass:CommerceAEACategoryTitleCell.class forCellWithReuseIdentifier:kTitleCellID];
...
- (void)setItems:(NSArray<CommerceAEACategoryItem *> *)items {
    _items = items;
...
- (__kindof UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    CommerceAEACategoryTitleCell *titleCell = [collectionView dequeueReusableCellWithReuseIdentifier:kTitleCellID forIndexPath:indexPath];
...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath {
    CommerceAEACategoryItem *item = self.dataArray[indexPath.item];
