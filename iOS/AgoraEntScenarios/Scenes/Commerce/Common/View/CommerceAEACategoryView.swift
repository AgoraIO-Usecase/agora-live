...
class CommerceAEACategoryItem: NSObject {
    var normalImage: UIImage?
    var selectedImage: UIImage?
    
    class func item(withNormalImage normalImage: UIImage?, selectedImage: UIImage?) -> CommerceAEACategoryItem {
        let item = CommerceAEACategoryItem()
...
protocol CommerceAEACategoryViewDelegate: AnyObject {
    func categoryView(_ categoryView: CommerceAEACategoryView, didSelectItemat index: Int)
}

class CommerceAEACategoryViewLayout: NSObject {
    var itemSize: CGSize = .zero
    var minSpacing: CGFloat = 0
    var contentInsets: UIEdgeInsets = .zero
    
    class func defaultLayout() -> CommerceAEACategoryViewLayout {
...
class CommerceAEACategoryView: UIView, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    private let kTitleCellID = "AEACategoryTitleCell"
    private var selectedIndex: Int = 0
    
    weak var delegate: CommerceAEACategoryViewDelegate?
    ...
    var items: [CommerceAEACategoryItem] = [] {
        didSet {
            dataArray = items
            collectionView.reloadData()
        }
    ...
    private var categoryLayout: CommerceAEACategoryViewLayout!
    ...
    convenience init(defaultLayout: CommerceAEACategoryViewLayout) {
    ...
    private func createSubviews(with categoryLayout: CommerceAEACategoryViewLayout) {
        ...
        collectionView.register(CommerceAEACategoryTitleCell.self, forCellWithReuseIdentifier: kTitleCellID)
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        let titleCell = collectionView.dequeueReusableCell(withReuseIdentifier: kTitleCellID, for: indexPath) as! CommerceAEACategoryTitleCell
