...
class ShowThumnbnailCanvasView: UIView {
    override init(frame: CGRect) {
        ...
        NSLayoutConstraint.activate([
            blurEffectView.topAnchor.constraint(equalTo: blurEffectView.topAnchor),
            blurEffectView.leadingAnchor.constraint(equalTo: blurEffectView.leadingAnchor),
            blurEffectView.trailingAnchor.constraint(equalTo: blurEffectView.trailingAnchor),
            blurEffectView.bottomAnchor.constraint(equalTo: blurEffectView.bottomAnchor)
        ])
    }
