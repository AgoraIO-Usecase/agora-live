...
//        case .filter: return "create_beauty_setting_filter".show_localized
        case .style: return "create_beauty_setting_special_makeup".show_localized
        case .adjust: return "create_beauty_setting_special_adjust".show_localized
        case .animoji: return "create_beauty_setting_special_animoji".show_localized
        case .sticker: return "create_beauty_setting_sticker".show_localized
        case .background: return "create_beauty_setting_background".show_localized
        }
    }
}
